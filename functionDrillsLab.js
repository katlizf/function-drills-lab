...
// console.log(exclaimTwo('i am groot'))
...
function nameCheck (nameParam) {
  if (nameParam === 'Steven') {
    ...
    return 'Hey Bryan!'
  } else if (nameParam !== 'Steven' && nameParam !== 'Bryan') {
    return `Cool name, ${nameParam}`
  }
}
let nameGreeting = nameCheck('Pam')
...
//CODE HERE
const frogs = function(goldToSpend) {
    return goldToSpend /3
}
...
//CODE HERE
const frogs2 = function(goldToSpend) {
  return Math.floor(goldToSpend/3)
}

let totalFrogs2 = (frogs2(10))
...
let arrayIsAscending = arrayFunction(sampleArray)
